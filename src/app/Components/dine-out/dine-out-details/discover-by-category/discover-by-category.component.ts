...
export class DiscoverByCategoryComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRouter.paramMap.subscribe((params: ParamMap)=>{
              ...
              let sortByRestaurantMood=this.activatedRouter.snapshot.paramMap.get('Mood');
              let  sortByRestaurantDish=this.activatedRouter.snapshot.paramMap.get('Dish');
              let sortByRestaurantLocation=this.activatedRouter.snapshot.paramMap.get('Location');
              console.log(sortByRestaurantDish)
              console.log(sortByRestaurantMood)
              ...
              if(sortByRestaurantLocation){
                this.restaurants.getRestaurantByLocation(sortByRestaurantLocation).subscribe(
